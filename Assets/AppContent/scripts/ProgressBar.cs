...
public class ProgressBar : MonoBehaviour {
	...
	void Update () {
		...
		if (hitTemp != null || hitInfo.collider != null) {
			if (hitTemp == hitInfo.collider && clicked == false && (hitInfo.collider.name == "exitPlane" || hitInfo.collider.name == "replayButton" || hitInfo.collider.name == "Plane1" || hitInfo.collider.name == "Plane2" || hitInfo.collider.name == "Plane3" || hitInfo.collider.name == "Plane4" || hitInfo.collider.name == "Plane5" || hitInfo.collider.name == "Plane6" || hitInfo.collider.name == "Plane7" || hitInfo.collider.name == "Plane8" || hitInfo.collider.name == "Plane9")) {
				if (currentAmount < 100) {
                    ...
                    }else if(hitInfo.collider.name == "exitPlane")
                    {
                        Debug.Log("exiti gordu");
                        QuitGame();
                    }
