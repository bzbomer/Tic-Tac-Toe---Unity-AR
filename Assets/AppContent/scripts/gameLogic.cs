...
public class gameLogic : MonoBehaviour
{
    ...
    public GameObject[] kapsullerDikey;
    public GameObject[] kapsullerYatay;
    public GameObject[] kapsullerCapraz;
...
*/
                    ...
                    Debug.Log("AirClick name'i : " + AirClick);
					a++;
					move = false;
					...
					if (OX [0] == 'X' && OX [1] == 'X' && OX [2] == 'X') {
                        kapsullerYatay[0].SetActive(true);
						winPlayer = true;
					...
					if (OX [3] == 'X' && OX [4] == 'X' && OX [5] == 'X') {
                        kapsullerYatay[1].SetActive(true);
                        winPlayer = true;
					...
					if (OX [6] == 'X' && OX [7] == 'X' && OX [8] == 'X') {
                        kapsullerYatay[2].SetActive(true);
                        winPlayer = true;
					...
					if (OX [0] == 'X' && OX [3] == 'X' && OX [6] == 'X') {
                        kapsullerDikey[0].SetActive(true);
                        winPlayer = true;
					...
					if (OX [1] == 'X' && OX [4] == 'X' && OX [7] == 'X') {
                        kapsullerDikey[1].SetActive(true);
                        winPlayer = true;
					...
					if (OX [2] == 'X' && OX [5] == 'X' && OX [8] == 'X') {
                        kapsullerDikey[2].SetActive(true);
                        winPlayer = true;
					...
					if (OX [0] == 'X' && OX [4] == 'X' && OX [8] == 'X') {
                        kapsullerCapraz[0].SetActive(true);
                        winPlayer = true;
					...
					if (OX [2] == 'X' && OX [4] == 'X' && OX [6] == 'X') {
                        kapsullerCapraz[1].SetActive(true);
                        winPlayer = true;
			...
			if (winPlayer || winComputer || equal) {
				...
				if (winComputer) {
                    ...
                    textmesh[1].SetActive(true);
                    // turn victory model/effects
                }
				if (equal) {
					Debug.Log ("EQUAL");
                    textmesh[2].SetActive(true);
                    // turn victory model/effects
                }
	...
	IEnumerator TimeDelay ()
	{
		...
		for (int i = 0; i < 9; i++) {
			if (currentPoint.name == planePlaces [i].name) { //hitInfo.collider.name
				...
				Debug.Log ("i: " + i);
				GameObject.Find (planePlaces [i].name).SetActive (false);
				O = Instantiate (modelPrefabs [1], planePlaces [i].transform.position,Quaternion.identity /*planePlaces [i].transform.rotation*/ ) as Transform;
